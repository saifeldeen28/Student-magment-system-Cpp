...
int main() {
  ...
  //  Course c1("physics Ol",1,3,instructor_ids,number_of_instructors);
    //Course c2("math",2,4,instructor_ids,1);
    //Course c3("chemistry",3,5,instructor_ids,1);
    //Course c4("biology",4,6,instructor_ids,1);
    //Course c5("physics Al",5,3,instructor_ids,1);
    //Student student(2,"joe","456");
    //student.add(c1,50);
    //student.add(c2,80);
    //student.add(c3,100);
    //student.add(c4,100);
